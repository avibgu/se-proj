...
public class DBHandlerTest {
	...
	public void testInsertAgent() {
		_db.insertAgent("20", new AgentType("COORDINATOR").getType(), true, "123123", "345345");
		String activityId = _db.getAgentActivityId("20");
		assertEquals("123123", activityId);
		_db.deleteAgent("20");
	}
	...
	public void testGetAgentIds() {
		_db.insertAgent("20", new AgentType("COORDINATOR").getType(), true, "123123", "345345");
		_db.insertAgent("21", new AgentType("COORDINATOR").getType(), true, "1232", "546");
		Vector<String> ids = _db.getAgentIds();
		assertEquals(2, ids.size());
		String activityId1 = _db.getAgentActivityId("20");
		String activityId2 = _db.getAgentActivityId("21");
		assertEquals("123123", activityId1);
		assertEquals("1232", activityId2);
		_db.deleteAgent("20");
		_db.deleteAgent("21");
	}
	...
	public void testChangeAgentStatus() {
		...
		_db.insertAgent("20", new AgentType("COORDINATOR").getType(), false, "123123", "345345");
