...
CREATE TABLE app.c2dm  (
	auth_key VARCHAR(1000) PRIMARY KEY
);

SELECT ACTUAL_END_TIME FROM APP.ACTIVITIES
WHERE ACTIVITY_ID='81c83988-bdeb-452c-a0cd-9cbd69e9f40e'
